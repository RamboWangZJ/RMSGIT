...
@interface CreateTelCheckViewController ()

@end

@implementation CreateTelCheckViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    for (UIViewController *controller in self.navigationController.viewControllers) {
        if ([controller isKindOfClass:[CreatTelViewController class]]) {
            
            CreatTelViewController *VC=(CreatTelViewController *)controller;
