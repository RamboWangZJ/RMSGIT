...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.itemSize = CGSizeMake(SCREEN_WIDTH/7, 86*HSCALE);//每个cell的大小
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat itemWidth = ([UIScreen mainScreen].bounds.size.width)/7.0;
    attributes.frame = CGRectMake(indexPath.row % 7 * itemWidth, indexPath.row / 7 * 86*HSCALE, itemWidth, 86*HSCALE);
    return attributes;
}
