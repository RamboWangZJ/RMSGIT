...
typedef NS_ENUM(NSInteger, CollectionViewCellSelectType) {
    CellSelectTypeYuan,   //
    CellSelectTypeLeftYuan,    //
    CellSelectTypeRightYuan,   //
    CellSelectTypeCenter    //
};
...
@property (assign, nonatomic) CollectionViewCellSelectType selectStyle;//显示的样式
...
//
@property (nonatomic, assign) BOOL is_warehouse;
@property (nonatomic, assign) NSInteger homeNum;
@property (nonatomic, strong) NSString *money;//房价 现在没有了

@property(nonatomic , strong)NSString  *type;//

@property(nonatomic , strong)NSString  *todayTimeStr;//2016-11-15
